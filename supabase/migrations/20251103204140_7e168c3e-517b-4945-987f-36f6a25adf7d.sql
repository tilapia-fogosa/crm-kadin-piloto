-- LOG: Recriar view horarios_ocupados incluindo eventos_professor
...
-- LOG: Criar view com 5 fontes de ocupação:
-- 1. Turmas regulares (aulas recorrentes)
-- 2. Aulas experimentais (data específica)
-- 3. Aulas inaugurais (data específica)
-- 4. Eventos de professor (recorrentes e únicos)
-- 5. Horários fora do expediente
...
-- LOG: FONTE 6 - Horários fora do expediente
SELECT 
...
-- LOG: View criada com sucesso incluindo eventos de professor!